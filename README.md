...
|4. | Hapus data | Klik **Delete** di kolom aksi, konfirmasi saat muncul dialog. | Baris produk menghilang dari tabel. Pesan “Produk berhasil dihapus” muncul. File gambar (jika ada) akan ikut terhapus saat melakukan delete.
